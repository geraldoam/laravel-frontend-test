	...
	<div class="container formFormatLogin">
		<form action="login.php" method="POST">
		  ...
		  <div class="form-group">
		    ...
		    <input name="email" type="email" class="form-control formPlaceholderCenter" id="email" placeholder="Email" required="true">
		  </div>

		  <div class="form-group formSpace">
		    <center><i class="fas fa-lock formIconWhite"></i></center>
		    <input name="password" type="password" class="form-control formPlaceholderCenter" id="password" placeholder="Senha" required="true">
		  </div>

		  <div class="formButtonsFormat">
		  	<button type="submit" class="btn btn-sm btn-info">Entrar</button>
		  	<a class="btn btn-sm btn-secondary" href="form-register.php">Registrar</a>
		  </div>
		</form>	
	</div>	
